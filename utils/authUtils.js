...
const sendVerificationEmail=(email, verifiedToken)=>{
    const transporter=nodemailer.createTransport({
       ...
       service:"gmail",
       auth:{
        user:"webdeveloper1227@gmail.com",
        pass:"afxu krfw oeee anvw"
       }
    })
    const mailOptions={
      from:"webdeveloper1227@gmail.com",
      to:email,
        ...
        <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
            ...
            <tr>
              ...
              <a href="${process.env.DOMAIN_URL}/verifytoken/${verifiedToken}" style=" border: none;
...
module.exports = { userDataValidation, isEmailRgex, generateToken, sendVerificationEmail };
